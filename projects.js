...

{
  ...
  description: "Buiding a retrieval-augmented generation assistant for querying documents, using local models instead of paid APIs to keep the pipeline self-hosted and cost-free.",
